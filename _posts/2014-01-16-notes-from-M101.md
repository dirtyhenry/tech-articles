...
**Work in Progress!** I switched from Python to Node.js and started over. I'm currently done with Week 4, "Multikey Continued".
{: .alert .alert-info}
...
### Creating an index
    ...
    db.collection.ensureIndex( { my_key: 1 } ) # 1 is ascending, -1 is descinding
